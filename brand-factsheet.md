# Brand Fact Sheet
*Thesis / Stasis — grounding doc before any lifecycle work*
...
| Product | Promise | Reviews |
|---------|---------|---------|
| **Clarity** | Focus & concentration | 3,080 · 4.6★ |
| **Motivation** | Energy & awareness (no jitters) | 1,899 · 4.6★ |
...
2. Algorithm recommends one formula
3. Subscribe or buy OTP
...
| Product | When | What it does |
|---------|------|--------------|
| **Stasis Day** | Upon waking, with stimulant | 23 ingredients — protects against neurotoxicity, steadier focus |
